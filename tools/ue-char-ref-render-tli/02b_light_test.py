...
OUTPUT_DIR    = r"D:/ref_shots/tli_light_test"
RESOLUTION    = (1024, 2304)
LEVEL_PATH    = "/Game/Maps/L_CharRefShoot"
TEST_CHARACTER = "AiRenDiLei"       # 改测怪物（Lit 材质，用来定灯光强度）
MESH_REQUIRE_PATH = "/Meshes/"
SEARCH_DIRS    = ["/Game/Art/Characters/Monster"]
FILL_RATIO    = 0.80
...
PRESETS = [
    {"name": "A_d60_ev0",  "sky": 20, "dir": 60,  "fill": 10, "rim": 15,
     "dir_pitch": -45, "dir_yaw": -30,
     "ev": 0.0, "sat": 1.0, "temp": 6500, "capture": "ldr", "flatten": False,
     "note": "无锁 dir60 ev0"},
    {"name": "B_d60_ev4",  "sky": 20, "dir": 60,  "fill": 10, "rim": 15,
     "dir_pitch": -45, "dir_yaw": -30,
     "ev": 4.0, "sat": 1.0, "temp": 6500, "capture": "ldr", "flatten": False,
     "note": "无锁 dir60 ev4（看 EV 起不起作用）"},
    {"name": "C_d300_ev0", "sky": 80, "dir": 300, "fill": 40, "rim": 60,
     "dir_pitch": -45, "dir_yaw": -30,
     "ev": 0.0, "sat": 1.0, "temp": 6500, "capture": "ldr", "flatten": False,
     "note": "无锁 dir300 超强灯（看灯起不起作用）"},
    {"name": "D_d60_ev8",  "sky": 20, "dir": 60,  "fill": 10, "rim": 15,
     "dir_pitch": -45, "dir_yaw": -30,
     "ev": 8.0, "sat": 1.0, "temp": 6500, "capture": "ldr", "flatten": False,
     "note": "无锁 dir60 ev8"},
    {"name": "E_base",     "sky": 0, "dir": 0, "fill": 0, "rim": 0,
     "dir_pitch": -45, "dir_yaw": -30,
     "ev": 0.0, "sat": 1.0, "temp": 6500, "capture": "base", "flatten": False,
     "note": "raw base color 对照"},
]
