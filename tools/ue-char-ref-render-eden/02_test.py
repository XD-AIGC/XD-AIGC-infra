...
# ============ 配置 ============
OUTPUT_DIR    = r"D:/角色识别数据/伊瑟_UE4_test"   # 测试输出目录（伊瑟 UE4）
RESOLUTION    = (1024, 2304)                    # W x H
LEVEL_PATH    = "/Game/Maps/L_CharRefShoot"
SEARCH_DIRS   = ["/Game/ArtResources/Characters/Cst"]  # 先拿 Cst 人形验证
MESH_REQUIRE_PATH = ""                           # 伊瑟 mesh 不在 /Meshes/ 子目录
TEST_MESH_HINT = "_LOD0"                          # 伊瑟 mesh 命名 SK_*_LOD0
TEST_CHARACTER  = "Arielle"                       # 指定角色名子串（None = 用字母序第一个）
EXCLUDE_PATH_KEYWORDS = ["/Weapon/", "/Sub1/", "/Sub2/", "/Sub3/", "/VFX/", "/Effect/", "/Anim/", "/Animations/"]
