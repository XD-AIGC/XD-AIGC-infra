...
# ============ 配置 ============
INPUT_ROOT = sys.argv[1] if len(sys.argv) > 1 else r"D:/角色识别数据/伊瑟_UE4"
OUTPUT_DIR = sys.argv[2] if len(sys.argv) > 2 else r"D:/角色识别数据/伊瑟_UE4_compose"
GAP_INNER = 64   # 角色之间留白
GAP_OUTER = 64   # 整张图四周留白
BG_COLOR = (96, 96, 96)  # 灰底（与单图灰底 96,96,96 一致；图本身已灰底，GAP 区域同灰）
